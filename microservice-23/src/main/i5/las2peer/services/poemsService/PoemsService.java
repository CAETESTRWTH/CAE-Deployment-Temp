...
@ServicePath("poems")
@ManualDeployment
public class PoemsService extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "23", version = "",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "mee", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAETESTRWTH/microservice-23/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final PoemsService service = (PoemsService) Context.getCurrent().getService();
...
temp2.put("text", "Sein Blick ist vom Vorübergehn der Stäbe so müd geworden, dass er nichts mehr hält. Ihm ist, als ob es tausend Stäbe gäbe und hinter tausend Stäben keine Welt. Der weiche Gang geschmeidig starker Schritte, der sich im allerkleinsten Kreise dreht, ist wie ein Tanz von Kraft um eine Mitte, in der betäubt ein großer Wille steht. Nur manchmal schiebt der Vorhang der Pupille sich lautlos auf -. Dann geht ein Bild hinein, geht durch der Glieder angespannte Stille - und hört im Herzen auf zu sein."); 
a.add(temp);
a.add(temp2);
