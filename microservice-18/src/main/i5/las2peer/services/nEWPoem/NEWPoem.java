...
@ManualDeployment
public class NEWPoem extends RESTService {
  ...
  public static class RootResource {
    ...
    private final NEWPoem service = (NEWPoem) Context.getCurrent().getService();
  ...
  @ApiOperation(value = "loadPoems", notes = " ")
  public Response loadPoems() {
