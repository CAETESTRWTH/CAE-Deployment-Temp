...
public class ijijTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(ijij.class.getCanonicalName(),"0.1");

  private static final String mainPath = "ijij";
