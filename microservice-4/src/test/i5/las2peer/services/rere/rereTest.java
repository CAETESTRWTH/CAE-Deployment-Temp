...
public class rereTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(rere.class.getCanonicalName(),"0.1");

  private static final String mainPath = "rere";
