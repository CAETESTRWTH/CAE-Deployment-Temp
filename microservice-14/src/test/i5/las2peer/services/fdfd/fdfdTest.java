...
public class fdfdTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(fdfd.class.getCanonicalName(),"0.1");

  private static final String mainPath = "fdfd";
