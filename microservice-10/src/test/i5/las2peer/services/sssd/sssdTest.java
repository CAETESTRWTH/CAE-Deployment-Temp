package i5.las2peer.services.sssd;
...
public class sssdTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(sssd.class.getCanonicalName(),"0.1");

  private static final String mainPath = "/sdsds";
